...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expression> expr let assign ifcond loop
    ...
    /* Precedence in crease from top to bottom. See 11.1 in cool-manual */
    %right ASSIGN
    %left NOT
    %nonassoc LE '<' '='
    %left '+' '-'
    ...
    */
    ...
    /* Formals can be empty, one or many */
    formal_list:     /* empty */
    { $$ = nil_Formals(); }
    | formal        /* one */
    { $$ = single_Formals($1);}
    | formal_list ',' formal    /* many */
    ...
    /* There are two type of expression lists
        1.  [,expr]*
        2.  [expr;]+
     */
    expr_list1: /*empty*/
    ...
    /* If condition */
    ifcond: IF expr THEN expr ELSE expr FI
    { $$ = cond($2, $4, $6); }
    ;
