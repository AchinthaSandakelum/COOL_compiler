...
// For assign the classtags and to code the class_nameTab
...
// To code the class prototype object
...
// To code the string prototype object
...
// Used to Record all the class features 
